...
## Data
The dataset `SimUBIDataset.jld2` is a cleaned simulation driving behavior dataset containing daily-summarized statistics for 553 drivers, mirroring their long-term driving behavior through a day-to-day time window. JLD2 stands for Julia Data Format 2, a file format and serialization library tailored to work seamlessly with native Julia types. 
