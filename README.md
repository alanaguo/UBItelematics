...
## Data
The dataset `SimUBIDataset` is a cleaned simulation driving behavior dataset containing daily-summarized statistics for **X** drivers, based on their aggregated driving behavior data over a 2–3 year period. 
